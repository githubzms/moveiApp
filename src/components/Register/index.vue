<template>
  <div>
    <van-cell-group>
      ...
      <van-field type="password" label="确认密码" placeholder="请再次输入密码" required />
    ...
    <van-button type="danger" @click="post_register" style="width:100%;margin-top:20px">注册</van-button>
  </div>
</template>
